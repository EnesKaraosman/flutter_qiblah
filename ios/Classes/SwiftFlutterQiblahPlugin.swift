...
public class SwiftFlutterQiblahPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    ...
    let compassChannel = FlutterEventChannel(name: "ml.medyas.flutter_qiblah/compass", binaryMessenger: registrar.messenger())
    let compassStreamHandler = FlutterQiblahCompassStreamHandler()
...
class FlutterQiblahCompassStreamHandler: NSObject, FlutterStreamHandler, CLLocationManagerDelegate {
